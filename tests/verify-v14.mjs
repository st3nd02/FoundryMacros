...
assert.match(allSource, /const COGITATOR_VERSION = "3\.1\.4";/);
...
assert.match(psychicWorkflow, /\{ width: 1000 \}\)\.render\(true\);/);
assert.match(allSource, /Precognitive Dodge/);
assert.match(allSource, /calculateSprayHordeBaseMagnitude/);
